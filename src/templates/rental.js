...
class RentalTemplate extends Component {
  ...
  render() {
    ...
    let property = this.props.data.wpRental
    let team = this.props.data.allWpTeam.nodes
    let related = this.props.data.allWpRental.nodes
    let people = []
    let { videoLightbox, floorplanLightbox, imageLightbox, showMore } = this.state
      ...
      <>
              ...
              <div className='property__inner property-archive__items'>
                <div className='card card--property'>
                  { property.propertyImages?.length > 0 &&
                    <div className='card__image' onClick={() => this.setState({ imageLightbox: !imageLightbox })}>
                      <img src={property.propertyImages[property.propertyImages.length > 1 ? 1 : 0].large} />
                      { sold && <div className='card__sold'><span>Leased</span></div> }
                    </div>
                  }
            ...
            <Fade distance='40px' bottom>
              <div className='property__inner'>
                <div className='property__content'>
                  ...
                  { property.propertyListing.marketingStatus === 'Sold' && <h4 className='property__price'>${ parseFloat(property.propertyListing.soldPrice).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,').replace(/\.00/, '') }</h4> }
                  ...
                  <ul className='property__buttons'>
                    <li>
                      <button
                        type='button'
                        onClick={() => this.setState({ imageLightbox: !imageLightbox })}
                      >
                        Gallery
                      </button>
                    </li>
                ...
                <div className='property__contact'>
                  { property.propertyListing.marketingStatus === 'Available' && property.propertyInspections?.length > 0 && hasInspections &&
            ...
            <section className='property__gallery'>
              <div className='property__inner'>
                {property.propertyImages?.slice(2, 5).map((el, i) => (
                  <div className='property__image' key={i} onClick={() => this.setState({ imageLightbox: !imageLightbox })}>
                    <Fade distance='40px' bottom>
            ...
            <section className='property__related'>
              <div className='property__inner'>
                <div className='featured-properties__header'>
                  ...
                  <Link className='btn btn-black' to='/lease/'>View All</Link>
                </div>
        ...
        { property.propertyImages?.length > 0 &&
          <FsLightbox
            ...
            sources={property.propertyImages.map((el, idx) => (
              <img
...
export const rentalQuery = graphql`
